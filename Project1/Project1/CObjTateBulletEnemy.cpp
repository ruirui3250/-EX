...
CObjTateBulletEnemy::CObjTateBulletEnemy(float x, float y)
{
	m_x = x;
	m_y = y;
}
...
//アクション
void CObjTateBulletEnemy::Action()
{
	//Resourcesの描画物RECT
