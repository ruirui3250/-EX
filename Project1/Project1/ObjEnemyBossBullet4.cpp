...
#include "GameHead.h"
#include "ObjEnemyBossBullet4.h"
#include"UtilityModule.h"

//使用するネーム
using namespace GameL;

ObjEnemyBossBullet4::ObjEnemyBossBullet4(float x, float y)
{
	m_x = x;
	m_y = y;
}
...
//アクション
void ObjEnemyBossBullet4::Action()
{
	//Resourcesの描画物RECT
