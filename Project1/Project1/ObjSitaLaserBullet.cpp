...
//コンストラクタ
CObjSitaLaserBullet::CObjSitaLaserBullet(float x, float y)
{
	m_x = x;
	m_y = y;
}
...
void CObjSitaLaserBullet::Init()
{
	...
	//当たり判定HItBoxを作成
	Hits::SetHitBox(this, m_x, m_y, 32, 64, ELEMENT_PLAYER, OBJ_SITA_LASER_BULLET, 1);
}
//アクション
void CObjSitaLaserBullet::Action()
{
	//Resourcesの描画物RECT
