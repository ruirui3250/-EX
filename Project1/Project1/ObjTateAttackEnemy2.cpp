...
//コンストラクタ
CObjTateAttackEnemy2::CObjTateAttackEnemy2(float x, float y)
{
	m_x = x;
	m_y = y;
}
...
//イニシャライズ
void CObjTateAttackEnemy2::Init()
{
	m_hp = 50;
	m_vx = 0.0f;
	m_vy = 0.0f;
	...
	m_del = 0;
	//当たり判定用HitBoxを作成.
	Hits::SetHitBox(this, m_x, m_y, /*横長*/32,/*縦長*/ 32, ELEMENT_ENEMY, OBJ_ATTACK_ENEMY2, 1);

}
//アクション
void CObjTateAttackEnemy2::Action()
{
	m_time++;//1加算
...
//ドロー
void CObjTateAttackEnemy2::Draw()
{
	//描画カラー情報
