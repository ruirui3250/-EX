...
//コンストラクタ
CObjTateEnemy2::CObjTateEnemy2(float x, float y)
{
	m_x = x;
	m_y = y;
}
...
void CObjTateEnemy2::Init()
{
	...
	//当たり判定用HitBox作成
	Hits::SetHitBox(this, m_x, m_y, 32, 32, ELEMENT_ENEMY, OBJ_TATE_ENEMY2, 1);
}
//アクション
void CObjTateEnemy2::Action()
{
	//角度計算
	m_r += 2.0f;
	//360°で元に戻す
